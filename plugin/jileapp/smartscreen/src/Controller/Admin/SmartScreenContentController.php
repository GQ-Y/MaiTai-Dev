...
use Plugin\Jileapp\Smartscreen\Service\SmartScreenContentService;
use Hyperf\HttpServer\Contract\RequestInterface;

#[Controller(prefix: 'admin/plugin/smart-screen/content')]
class SmartScreenContentController extends AbstractController
{
    #[Inject]
    protected SmartScreenContentService $service;
    #[Inject]
